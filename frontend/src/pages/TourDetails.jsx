...
const TourDetails = () => {
    ...
    //  this is a static data and later on we will call our API and load our data from database
                        ...
                        <div className="tour__content">
                            ...
                            <div className="tour__info">
                                ...
                                <div className="tour__extra-details">
                                    ...
                                    <span><i class="ri-map-pin-2-line"></i>  ${price} </span>
                                                    ...
                                                    <div className="w-100">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <h5>Parlaya</h5>
                                                                <p>
                                                                    {new Date("07-21-24").toLocaleDateString('en-US',options)}
                                                                </p>
                                                            </div>
                                                            <span className="d-flex align-items-center">{avgRating}
